...
class _LoginPageState extends State<LoginPage> {
  ...
  final url = Uri.parse('https://eliuwjh1sfjv.share.zrok.io/api/login');  // Replace with actual API URL
  ...
  try {
    ...
    if (response.statusCode == 200) {
      // If login is successful, fetch user details using the GET request
...
await box.put('userRole', userDetails['role']);  
        ...
        if (role == 'ADMIN') {
          // Navigate to the admin page if the role is 'admin'
